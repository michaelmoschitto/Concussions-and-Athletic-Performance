...
class FeatureSelector:
    ...
    def get_results(self, X_cols):
        ...
        result = pd.DataFrame({"features" : features, "score" : scores,"ci bound" : confidences ,"feature idx" : indicies,"model" : [self.estimator_name] * len(features)}).sort_values(by="score", ascending=False)
